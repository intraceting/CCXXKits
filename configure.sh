...
usage: [ OPTIONS ]
    ...
    -d < name=value >
     ...
     TARGET_KIT_NAME=${TARGET_KIT_NAME}

     TARGET_KIT_NAME(组件包名字)支持以下关键字:
     deb,rpm
...
#
NATIVE_RELEASE_NAME=${NATIVE_PLATFORM}-gcc${NATIVE_COMPILER_VERSION}-libc${NATIVE_GLIBC_MAX_VERSION}
...
SYSROOT_PATH=${SHELLDIR}/sysroot/${TARGET_RELEASE_NAME}/
...
#
export C2X2K_NATIVE_COMPILER_PREFIX=${NATIVE_COMPILER_PREFIX}
export C2X2K_NATIVE_COMPILER_C=${NATIVE_COMPILER_C}
export C2X2K_NATIVE_COMPILER_CXX=${NATIVE_COMPILER_CXX}
export C2X2K_NATIVE_COMPILER_FORTRAN=${NATIVE_COMPILER_FORTRAN}
export C2X2K_NATIVE_COMPILER_SYSROOT=${NATIVE_COMPILER_SYSROOT}
export C2X2K_NATIVE_COMPILER_AR=${NATIVE_COMPILER_AR}
export C2X2K_NATIVE_COMPILER_LD=${NATIVE_COMPILER_LD}
export C2X2K_NATIVE_COMPILER_RANLIB=${NATIVE_COMPILER_RANLIB}
export C2X2K_NATIVE_COMPILER_READELF=${NATIVE_COMPILER_READELF}
#
export C2X2K_NATIVE_CMAKE_BIN=${NATIVE_CMAKE_BIN}
#
export C2X2K_TARGET_COMPILER_PREFIX=${TARGET_COMPILER_PREFIX}
export C2X2K_TARGET_COMPILER_C=${TARGET_COMPILER_C}
export C2X2K_TARGET_COMPILER_CXX=${TARGET_COMPILER_CXX}
export C2X2K_TARGET_COMPILER_FORTRAN=${TARGET_COMPILER_FORTRAN}
export C2X2K_TARGET_COMPILER_SYSROOT=${TARGET_COMPILER_SYSROOT}
export C2X2K_TARGET_COMPILER_AR=${TARGET_COMPILER_AR}
export C2X2K_TARGET_COMPILER_LD=${TARGET_COMPILER_LD}
export C2X2K_TARGET_COMPILER_RANLIB=${TARGET_COMPILER_RANLIB}
export C2X2K_TARGET_COMPILER_READELF=${TARGET_COMPILER_READELF}
#
export C2X2K_TARGET_KIT_NAME=${TARGET_KIT_NAME}
#
export C2X2K_NATIVE_MACHINE=${NATIVE_MACHINE}
export C2X2K_TARGET_MACHINE=${TARGET_MACHINE}
export C2X2K_NATIVE_PLATFORM=${NATIVE_PLATFORM}
export C2X2K_TARGET_PLATFORM=${TARGET_PLATFORM}
export C2X2K_NATIVE_ARCH=${NATIVE_ARCH}
export C2X2K_TARGET_ARCH=${TARGET_ARCH}
export C2X2K_NATIVE_BITWIDE=${NATIVE_BITWIDE}
export C2X2K_TARGET_BITWIDE=${TARGET_BITWIDE}
export C2X2K_NATIVE_COMPILER_VERSION=${NATIVE_COMPILER_VERSION}
export C2X2K_TARGET_COMPILER_VERSION=${TARGET_COMPILER_VERSION}
export C2X2K_NATIVE_GLIBC_MAX_VERSION=${NATIVE_GLIBC_MAX_VERSION}
export C2X2K_TARGET_GLIBC_MAX_VERSION=${TARGET_GLIBC_MAX_VERSION}
#
...
export C2X2K_SYSROOT_PATH=${SYSROOT_PATH}
export C2X2K_PACKAGE_PATH=${PACKAGE_PATH}
#
...
#
#限制目标平台.pc文件搜索路径范围。
export PKG_CONFIG_LIBDIR=\${C2X2K_SYSROOT_PATH}/lib\${C2X2K_TARGET_BITWIDE}/pkgconfig:\${C2X2K_SYSROOT_PATH}/lib/pkgconfig:\${C2X2K_SYSROOT_PATH}/share/pkgconfig
