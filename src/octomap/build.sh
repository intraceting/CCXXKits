...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-octomap") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/liboctomap.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/liboctomap.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/liboctomap.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/liboctomap.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-octomap"
}
fi
...
#
SRC_FILE=${SHELLDIR}/octomap-1.9.8.tar.xz
#
