...
{
CHECK_LISTS[0]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libarchive.a"
CHECK_LISTS[1]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libarchive.so"
CHECK_LISTS[2]="${C2X2K_PREFIX_PATH}/lib/libarchive.a"
CHECK_LISTS[3]="${C2X2K_PREFIX_PATH}/lib/libarchive.so"
}
else
{
