...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-nghttp2") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libnghttp2.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libnghttp2.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libnghttp2.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libnghttp2.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-nghttp2"
}
fi
...
#
SRC_FILE=${SHELLDIR}/nghttp2-1.55.0.tar.xz
#
