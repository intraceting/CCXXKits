...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-libxml2") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libxml2.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libxml2.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libxml2.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libxml2.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-libxml2"
}
fi
...
#
SRC_FILE=${SHELLDIR}/libxml2-2.13.0.tar.xz
#
...
${C2X2K_NATIVE_CMAKE_BIN} ${SRC_PATH} \
    ...
    -DLIBXML2_WITH_THREADS=ON \
    -DLIBXML2_WITH_MODULES=ON -DHAVE_DLOPEN=ON \
