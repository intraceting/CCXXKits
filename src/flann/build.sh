...
{
CHECK_LISTS[0]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libflann.a"
CHECK_LISTS[1]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libflann.so"
CHECK_LISTS[2]="${C2X2K_PREFIX_PATH}/lib/libflann.a"
CHECK_LISTS[3]="${C2X2K_PREFIX_PATH}/lib/libflann.so"
}
else
{
