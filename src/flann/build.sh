...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-flann") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libflann.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libflann.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libflann.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libflann.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-flann"
}
fi
...
#
SRC_FILE=${SHELLDIR}/flann-1.9.2.tar.xz
#
