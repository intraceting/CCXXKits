...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-libsrtp") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libsrtp2.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libsrtp2.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libsrtp2.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libsrtp2.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-libsrtp"
}
fi
...
#
SRC_FILE=${SHELLDIR}/libsrtp-2.7.0.tar.gz
#
...
${C2X2K_NATIVE_CMAKE_BIN} ${SRC_PATH} \
    ...
    -DENABLE_SANITIZE_LEAK=ON \
    -DENABLE_SANITIZE_THREAD=ON \
