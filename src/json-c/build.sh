...
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libjson-c.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libjson-c.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libjson-c.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libjson-c.so"
}
else
{
