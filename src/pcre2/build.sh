...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-prce2") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libpcre2-posix.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libpcre2-posix.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libpcre2-posix.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libpcre2-posix.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-prce2"
}
fi
...
#
SRC_FILE=${SHELLDIR}/pcre2-10.42.tar.xz
#
