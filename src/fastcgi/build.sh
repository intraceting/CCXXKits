...
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libfcgi.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libfcgi.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libfcgi.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libfcgi.so"
}
else
{
...
#
SRC_FILE=${SHELLDIR}/fcgi2-2.4.6.tar.gz
#
...
./configure \
    ...
    CXXFLAGS="-std=c++11 -fPIC -D_GNU_SOURCE" \
