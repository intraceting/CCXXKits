...
{
CHECK_LISTS[0]="${C2X2K_SYSROOT_PATH}/lib${C2X2K_TARGET_BITWIDE}/libbz2.a"
CHECK_LISTS[1]="${C2X2K_SYSROOT_PATH}/lib${C2X2K_TARGET_BITWIDE}/libbz2.so"
CHECK_LISTS[2]="${C2X2K_SYSROOT_PATH}/lib/libbz2.a"
CHECK_LISTS[3]="${C2X2K_SYSROOT_PATH}/lib/libbz2.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-bzip2"
}
fi
...
#
SRC_FILE=${SHELLDIR}/bzip2-1.0.8.tar.xz
#
