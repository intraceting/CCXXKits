...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-libqrencode") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libqrencode.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libqrencode.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libqrencode.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libqrencode.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-libqrencode"
}
fi
...
#
SRC_FILE=${SHELLDIR}/libqrencode-4.1.1.tar.xz
#
