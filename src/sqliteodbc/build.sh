...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-sqliteodbc") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libsqlite3odbc.a"
CHECK_LISTS[1]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libsqlite3odbc.so"
CHECK_LISTS[2]="${C2X2K_PREFIX_PATH}/lib/libsqlite3odbc.a"
CHECK_LISTS[3]="${C2X2K_PREFIX_PATH}/lib/libsqlite3odbc.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-sqliteodbc"
}
fi
...
#
SRC_FILE=${SHELLDIR}/sqliteodbc-0.99991.tar.xz
#
...
./configure \
    ...
    --with-sqlite3=${C2X2K_PREFIX_PATH} \
    --with-libxml2=${C2X2K_PREFIX_PATH} \
    --with-odbc=${C2X2K_PREFIX_PATH} \
    --with-dls \
    --enable-shared=yes \
