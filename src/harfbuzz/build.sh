...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-harfbuzz") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libharfbuzz.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libharfbuzz.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libharfbuzz.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libharfbuzz.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-harfbuzz"
}
fi
...
#
SRC_FILE=${SHELLDIR}/harfbuzz-7.3.0.tar.xz
#
