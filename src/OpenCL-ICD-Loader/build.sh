...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-opencl-icd-loader") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libOpenCL.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libOpenCL.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libOpenCL.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libOpenCL.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-opencl-icd-loader"
}
fi
...
#
SRC_FILE=${SHELLDIR}/OpenCL-ICD-Loader-2025.07.22.tar.gz
#
...
${C2X2K_NATIVE_CMAKE_BIN} ${SRC_PATH} \
    ...
    -DENABLE_OPENCL_LOADER_MANAGED_DISPATCH=ON \
