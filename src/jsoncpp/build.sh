...
{
CHECK_LISTS[0]="${C2X2K_SYSROOT_PATH}/lib${C2X2K_TARGET_BITWIDE}/libjsoncpp.a"
CHECK_LISTS[1]="${C2X2K_SYSROOT_PATH}/lib${C2X2K_TARGET_BITWIDE}/libjsoncpp.so"
CHECK_LISTS[2]="${C2X2K_SYSROOT_PATH}/lib/libjsoncpp.a"
CHECK_LISTS[3]="${C2X2K_SYSROOT_PATH}/lib/libjsoncpp.so"
}
else
{
