...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-jsoncpp") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libjsoncpp.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libjsoncpp.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libjsoncpp.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libjsoncpp.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-jsoncpp"
}
fi
...
#
SRC_FILE=${SHELLDIR}/jsoncpp-1.9.5.tar.xz
#
