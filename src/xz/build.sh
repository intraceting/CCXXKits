...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-xz") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/liblzma.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/liblzma.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/liblzma.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/liblzma.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-xz"
}
fi
...
#
SRC_FILE=${SHELLDIR}/xz-5.8.1.tar.gz
#
