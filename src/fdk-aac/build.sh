...
{
CHECK_LISTS[0]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libfdk-aac.a"
CHECK_LISTS[1]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libfdk-aac.so"
CHECK_LISTS[2]="${C2X2K_PREFIX_PATH}/lib/libfdk-aac.a"
CHECK_LISTS[3]="${C2X2K_PREFIX_PATH}/lib/libfdk-aac.so"
}
else
{
