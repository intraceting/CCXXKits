...
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libopencv_core.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libopencv_core.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libopencv_core.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libopencv_core.so"
}
else
{
