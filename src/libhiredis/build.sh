...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-libhiredis") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libhiredis.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libhiredis.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libhiredis.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libhiredis.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-libhiredis"
}
fi
...
#
SRC_FILE=${SHELLDIR}/hiredis-1.3.0.tar.gz
#
