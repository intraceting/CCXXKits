...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-zlmediakit") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libmk_api.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libmk_api.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libmk_api.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libmk_api.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-zlmediakit"
}
fi
...
#
SRC_FILE=${SHELLDIR}/ZLMediaKit-2025-0924.tar.xz
#
