...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-faad2") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_SYSROOT_PATH}/lib${C2X2K_TARGET_BITWIDE}/libfaad2.a"
CHECK_LISTS[1]="${C2X2K_SYSROOT_PATH}/lib${C2X2K_TARGET_BITWIDE}/libfaad2.so"
CHECK_LISTS[2]="${C2X2K_SYSROOT_PATH}/lib/libfaad2.a"
CHECK_LISTS[3]="${C2X2K_SYSROOT_PATH}/lib/libfaad2.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-faad2"
}
fi
...
#
SRC_FILE=${SHELLDIR}/faad2-2.11.2.tar.gz
#
