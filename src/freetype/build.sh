...
{
CHECK_LISTS[0]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libfreetype.a"
CHECK_LISTS[1]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libfreetype.so"
CHECK_LISTS[2]="${C2X2K_PREFIX_PATH}/lib/libfreetype.a"
CHECK_LISTS[3]="${C2X2K_PREFIX_PATH}/lib/libfreetype.so"
}
else
{
