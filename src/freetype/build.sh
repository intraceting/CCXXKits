...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-freetype") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libfreetype.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libfreetype.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libfreetype.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libfreetype.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-freetype"
}
fi
...
#
SRC_FILE=${SHELLDIR}/freetype-2.13.0.tar.xz
#
