...
{
CHECK_LISTS[0]="${C2X2K_SYSROOT_PATH}/lib${C2X2K_TARGET_BITWIDE}/libcares.a"
CHECK_LISTS[1]="${C2X2K_SYSROOT_PATH}/lib${C2X2K_TARGET_BITWIDE}/libcares.so"
CHECK_LISTS[2]="${C2X2K_SYSROOT_PATH}/lib/libcares.a"
CHECK_LISTS[3]="${C2X2K_SYSROOT_PATH}/lib/libcares.so"
}
else
{
