...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-c-ares") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libcares.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libcares.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libcares.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libcares.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-c-ares"
}
fi
...
#
SRC_FILE=${SHELLDIR}/c-ares-1.34.5.tar.gz
#
