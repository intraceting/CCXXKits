...
{
CHECK_LISTS[0]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libcurl.a"
CHECK_LISTS[1]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libcurl.so"
CHECK_LISTS[2]="${C2X2K_PREFIX_PATH}/lib/libcurl.a"
CHECK_LISTS[3]="${C2X2K_PREFIX_PATH}/lib/libcurl.so"
}
else
{
...
${C2X2K_NATIVE_CMAKE_BIN} ${SRC_PATH} \
    ...
    -DCMAKE_C_FLAGS="-fPIC -Wl,-rpath-link=${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE} -Wl,-rpath-link=${C2X2K_PREFIX_PATH}/lib" \
    -DCMAKE_CXX_FLAGS="-fPIC -Wl,-rpath-link=${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE} -Wl,-rpath-link=${C2X2K_PREFIX_PATH}/lib" \
