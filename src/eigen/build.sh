...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-eigen") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/include/eigen3/Eigen/Core"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-eigen"
}
fi
...
#
SRC_FILE=${SHELLDIR}/eigen-3.4.0.tar.xz
#
