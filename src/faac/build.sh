...
{
CHECK_LISTS[0]="${C2X2K_SYSROOT_PATH}/lib${C2X2K_TARGET_BITWIDE}/libfaac.a"
CHECK_LISTS[1]="${C2X2K_SYSROOT_PATH}/lib${C2X2K_TARGET_BITWIDE}/libfaac.so"
CHECK_LISTS[2]="${C2X2K_SYSROOT_PATH}/lib/libfaac.a"
CHECK_LISTS[3]="${C2X2K_SYSROOT_PATH}/lib/libfaac.so"
}
else
{
