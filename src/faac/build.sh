...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-faac") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libfaac.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libfaac.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libfaac.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libfaac.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-faac"
}
fi
...
#
SRC_FILE=${SHELLDIR}/faac-faac-1.31.1.tar.gz
#
...
#
./bootstrap >>${C2X2K_BUILD_LOG_FILE} 2>&1
