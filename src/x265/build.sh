...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-x265") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libx265.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libx265.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libx265.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libx265.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-x265"
}
fi
...
#
SRC_FILE=${SHELLDIR}/x265-192.tar.xz
#
...
#
${C2X2K_NATIVE_CMAKE_BIN} ${SRC_PATH}/source/ \
    ${CMAKE_MORE_CONF} \
