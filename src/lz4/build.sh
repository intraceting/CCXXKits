...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-lz4") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/liblz4.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/liblz4.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/liblz4.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/liblz4.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-lz4"
}
fi
...
#
SRC_FILE=${SHELLDIR}/lz4-1.9.4.tar.xz
#
...
#编译.
make -j${C2X2K_BUILD_NPROC} allmost \
