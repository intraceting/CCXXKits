...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-usrsctp") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libusrsctp.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libusrsctp.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libusrsctp.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libusrsctp.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-usrsctp"
}
fi
...
#
SRC_FILE=${SHELLDIR}/usrsctp-0.9.5.0.tar.gz
#
