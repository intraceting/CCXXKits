...
{
CHECK_LISTS[0]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libssh.a"
CHECK_LISTS[1]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libssh.so"
CHECK_LISTS[2]="${C2X2K_PREFIX_PATH}/lib/libssh.a"
CHECK_LISTS[3]="${C2X2K_PREFIX_PATH}/lib/libssh.so"
}
else
{
