...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-libssh") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libssh.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libssh.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libssh.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libssh.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-libssh"
}
fi
...
#
SRC_FILE=${SHELLDIR}/libssh-0.11.3.tar.xz
#
