...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-zlib") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libz.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libz.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libz.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libz.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-zlib"
}
fi
...
#
SRC_FILE=${SHELLDIR}/zlib-1.2.13.tar.xz
#
