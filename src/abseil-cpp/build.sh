...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-abseil-cpp") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libabsl_base.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libabsl_base.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libabsl_base.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libabsl_base.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-abseil-cpp"
}
fi
...
#
SRC_FILE=${SHELLDIR}/abseil-cpp-20250512.1.tar.gz
#
