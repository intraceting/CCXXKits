...
{
CHECK_LISTS[0]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libabsl_base.a"
CHECK_LISTS[1]="${C2X2K_PREFIX_PATH}/lib${C2X2K_TARGET_BITWIDE}/libabsl_base.so"
CHECK_LISTS[2]="${C2X2K_PREFIX_PATH}/lib/libabsl_base.a"
CHECK_LISTS[3]="${C2X2K_PREFIX_PATH}/lib/libabsl_base.so"
}
else
{
