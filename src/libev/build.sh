...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-libev") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libev.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libev.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libev.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libev.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-libev"
}
fi
...
#
SRC_FILE=${SHELLDIR}/libev-4.33.tar.xz
#
