...
{
CHECK_LISTS[0]="${C2X2K_SYSROOT_PATH}/lib${C2X2K_TARGET_BITWIDE}/libev.a"
CHECK_LISTS[1]="${C2X2K_SYSROOT_PATH}/lib${C2X2K_TARGET_BITWIDE}/libev.so"
CHECK_LISTS[2]="${C2X2K_SYSROOT_PATH}/lib/libev.a"
CHECK_LISTS[3]="${C2X2K_SYSROOT_PATH}/lib/libev.so"
}
else
{
