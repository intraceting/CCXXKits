...
#
if [ $(check_keyword ${BUILD_FLAGS} "rebuild-mp4v2") -eq 0 ];then
{
CHECK_LISTS[0]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libmp4v2.a"
CHECK_LISTS[1]="${C2X2K_TARGET_PREFIX}/lib${C2X2K_TARGET_BITWIDE}/libmp4v2.so"
CHECK_LISTS[2]="${C2X2K_TARGET_PREFIX}/lib/libmp4v2.a"
CHECK_LISTS[3]="${C2X2K_TARGET_PREFIX}/lib/libmp4v2.so"
}
else
{
CHECK_LISTS[0]="/tmp/rebuild-mp4v2"
}
fi
...
#
SRC_FILE=${SHELLDIR}/mp4v2-2.1.3.tar.gz
#
