...
NATIVE_PKGCONFIG_BIN=$(which pkg-config)
NATIVE_MESON_BIN=$(which meson)
NATIVE_NINJA_BIN=$(which ninja)
...
usage: [ OPTIONS ]
    ...
    -d < name=value >
     ...
     NATIVE_CHRPATH_BIN=${NATIVE_CHRPATH_BIN}

     NATIVE_PKGCONFIG_BIN=${NATIVE_PKGCONFIG_BIN}

     NATIVE_MESON_BIN=${NATIVE_MESON_BIN}

     NATIVE_NINJA_BIN=${NATIVE_NINJA_BIN}
...
export C2X2K_NATIVE_PKGCONFIG_BIN=${NATIVE_PKGCONFIG_BIN}
export C2X2K_NATIVE_MESON_BIN=${NATIVE_MESON_BIN}
export C2X2K_NATIVE_NINJA_BIN=${NATIVE_NINJA_BIN}
#
...
export C2X2K_NATIVE_MULTIARCH=${C2X2K_NATIVE_MULTIARCH}
export C2X2K_TARGET_MULTIARCH=${C2X2K_TARGET_MULTIARCH}
#
